...
//═══════[Required Variables]════════\\
global.owner = process.env.OWNER_NUMBER.split("256707521863")
...
module.exports = {
  botname:   process.env.BOT_NAME === undefined ? 'Moriceug' : process.env.BOT_NAME,
  ...
  antibadword :  process.env.ANTI_BAD_WORD === undefined ? 'fuckyou' : process.env.ANTI_BAD_WORD,
  alwaysonline:  process.env.ALWAYS_ONLINE === undefined ? false : process.env.ALWAYS_ONLINE,
  antifake : process.env.FAKE_COUNTRY_CODE === undefined ? '256' : process.env.FAKE_COUNTRY_CODE,
